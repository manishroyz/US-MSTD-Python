...
def app():
    ...
    #Left Frame Buttons
    lf_button_left = tk.Button(left_frame_buttons, text="Plot Reference", command='', width=20)
    lf_button_right = tk.Button(left_frame_buttons, text="Plot Current", command='', width=20)
    ...
    right_frame_buttons1_tof = tk.Button(right_frame_buttons1, text="Computed TOF (seconds)", command=compute_tof(), width=25)
